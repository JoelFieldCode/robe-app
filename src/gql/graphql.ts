...
export type GetItemQuery = { __typename?: 'Query', getItem?: { __typename?: 'Item', name: string, id: number, image_url?: string | null, url: string, price: number, categoryId: number } | null };
...
export type UpdateCategoryMutation = { __typename?: 'Mutation', updateCategory?: { __typename?: 'Category', id: number, name: string } | null };
